...
var gzui = {
  ...
  loginTip: function (params) {
    ...
    var tpl = '<div class="login-tip">' +
      '<div class="login-tip-con">' +
        '<span>'+params.text+'</span><span class="login-tip-btn"><a class="cancel-login">暂不登录</a><a class="sign-in">马上登录</a></span>' +
      '</div>' +
      '</div>';
    $("body").append(tpl);
    setTimeout(function () {
  ...
  toast: function (params) {
    ...
    if($(".m-toast").length == 0){
      var tpl = "<div class='m-toast'><div class='m-toast-tip'><span class='m-toast-icon "+params.icon+"'></span><span>"+params.text+"</span></div></div>";
...
(function ($){
  ...
  $.fn.placeSelect = function (option) {
    var defaults = {
      placeCon: [{
        tab: {name: '国内热门'},
        city: [{name: '上海(SHA)',nameStr: '上海',nameCode: 'SHA'},{name: '北京(BJS)',nameStr: '北京',nameCode: 'BJS'},{name: '香港(HKG)',nameStr: '香港',nameCode: 'HKG'},{name: '广州(CAN)',nameStr: '广州',nameCode: 'CAN'}]
      },{
        tab: {name: '国际热门'},
        city: [{name: '首尔(SEL)',nameStr: '首尔',nameCode: 'SEL'},{name: '台北(TPE)',nameStr: '台北',nameCode: 'TPE'},{name: '东京(TYO)',nameStr: '东京',nameCode: 'TYO'},{name: '新加坡(SIN)',nameStr: '新加坡',nameCode: 'SIN'}]
      },{
        tab: {name: '亚洲'},
        city: [{name: '香港(HKG)',nameStr: '香港',nameCode: 'HKG'}]
      },{
        tab: {name: '欧洲'},
        city: [{name: '巴黎(PAR)',nameStr: '巴黎',nameCode: 'PAR'}]
      },{
        tab: {name: '南美洲'},
        city: [{name: '洛杉矶(LAX)',nameStr: '洛杉矶',nameCode: 'LAX'}]
      },{
        tab: {name: '非洲'},
        city: [{name: '开罗(CAI)',nameStr: '开罗',nameCode: 'CAI'}]
      }],
      searchCon: [{
        group: {
    ...
    var tpl = '<div class="place-select-popup">' +
      ...
      '</div><div class="keyup-search"><div class="search-normal-tip">未能搜索到该城市</div><div class="keyup-search-list"></div></div>';
...
(function ($){
    ...
    $.fn.placeSelectHotel = function (option) {
        var defaults = {
            placeCon: [{
                tab: {name: '国内热门'},
                city: [{name: '上海(SHA)',nameStr: '上海',nameCode: 'SHA'},{name: '北京(BJS)',nameStr: '北京',nameCode: 'BJS'},{name: '香港(HKG)',nameStr: '香港',nameCode: 'HKG'},{name: '广州(CAN)',nameStr: '广州',nameCode: 'CAN'},{name: '上海(SHA)',nameStr: '上海',nameCode: 'SHA'},{name: '北京(BJS)',nameStr: '北京',nameCode: 'BJS'},{name: '香港(HKG)',nameStr: '香港',nameCode: 'HKG'},{name: '北京(BJS)',nameStr: '北京',nameCode: 'BJS'},{name: '香港(HKG)',nameStr: '香港',nameCode: 'HKG'},{name: '北京(BJS)',nameStr: '北京',nameCode: 'BJS'},{name: '香港(HKG)',nameStr: '香港',nameCode: 'HKG'}]
            },{
                tab: {name: '国际热门'},
                city: [{name: '首尔(SEL)',nameStr: '首尔',nameCode: 'SEL'},{name: '台北(TPE)',nameStr: '台北',nameCode: 'TPE'},{name: '东京(TYO)',nameStr: '东京',nameCode: 'TYO'},{name: '新加坡(SIN)',nameStr: '新加坡',nameCode: 'SIN'}]
            },{
